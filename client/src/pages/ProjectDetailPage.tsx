  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h3 className="text-sm font-headline text-on-surface line-clamp-2 break-words">
...
export default function ProjectDetailPage() {
  ...
  const { data: project, error, mutate } = useSWR(id ? `/projects/${id}` : null, () => projectApi.getById(id!));
