...
const straight: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 48 24" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const elbow: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 36 36" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const tee: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 48 36" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
    <line x1="4" y1="12" x2="44" y2="12" />
...
const cross: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 40 40" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const yShape: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 40 36" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const plug: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 36 24" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const branch: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 48 32" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const union: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 48 28" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const nipple: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 32 20" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const checkValve: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 40 28" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const maleEnd: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 28 24" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const waterGun: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 44 28" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const leverHandle: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 32 24" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
...
const wheelHandle: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 28 28" className={className} fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
