...
export default function WorkbenchAuthDialog({
  ...
  return (
    <motion.section
      className={`workbench-auth-dialog workbench-auth-dialog-${mode} relative w-full max-w-[27rem] overflow-hidden rounded-2xl border border-outline-variant/14 bg-surface-container-low shadow-modal`}
      role="dialog"
      aria-modal="true"
