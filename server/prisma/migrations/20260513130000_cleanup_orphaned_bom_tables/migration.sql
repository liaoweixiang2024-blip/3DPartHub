...
-- DropForeignKey
ALTER TABLE IF EXISTS "selection_bom_media" DROP CONSTRAINT IF EXISTS "selection_bom_media_template_id_fkey";
ALTER TABLE IF EXISTS "selection_bom_rules" DROP CONSTRAINT IF EXISTS "selection_bom_rules_template_id_fkey";
ALTER TABLE IF EXISTS "selection_categories" DROP CONSTRAINT IF EXISTS "selection_categories_parent_id_fkey";
ALTER TABLE IF EXISTS "selection_templates" DROP CONSTRAINT IF EXISTS "selection_templates_category_id_fkey";
